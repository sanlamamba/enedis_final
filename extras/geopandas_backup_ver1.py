...
csv_files = {
    ...
    "reseau_souterrain_bt": {
        ...
        "mono_connection_per_endpoint": True,  # Only one connection allowed per endpoint.
    },
    "reseau_bt": {
...
def find_connections(
    ...
    - For LineString features, two separate buffers are computed:
      ...
      Otherwise, all candidates are collected.
    ...
    for idx, feature in gdf_proj.iterrows():
        ...
        # Process LineString features differently.
